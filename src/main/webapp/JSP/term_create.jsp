...
<div class="container modify">
    <p class="modify">Для создания семестра, заполните следующие данные и нажмите "Создать".</p>

    <form action="/term_create" method="post">
        <div class="row mb-3 tabmodify">
            <label  class="col-sm-2 col-form-label"></label>
            <div class="col-sm-5">
                <input type="text" class="form-control" placeholder="Название семестра" name="name" id="term" required>
                <input type="text" class="form-control" placeholder="Длительность в неделях" name="duration" required>
                <select class="form-select discselect" multiple aria-label="Multiple select example" placeholder="Выберите дисциплины" required>
