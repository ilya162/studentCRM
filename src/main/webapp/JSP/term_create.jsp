...
<div class="container modify">
    ...
    <form action="/term_create" method="post">
        <div class="row tabmodify">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control termcreate" placeholder="Название семестра" name="name" id="term" required>
                <input type="text" class="form-control termcreate" placeholder="Длительность в неделях" name="duration" required>

                <table class="table table-dark table-striped disctab">
