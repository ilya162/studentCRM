...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <p class="displist">Список студентов:</p>
            <table class="table table-dark table-striped-columns tabdata">
                ...
                <c:forEach items="${students}" var="st">
                    <tr>
                        <th scope="row">
                            <div>
                                <input class="form-check-input" type="checkbox" value="${st.id}" name="idStudent"
                                       aria-label="...">
                            </div>
                        </th>
                        <td>${st.ser_name}</td>
        ...
        <div class="col-sm-4 leftbut">
            <div class="d-grid gap-3 col-5 mx-auto">
                ...
                <input type="submit" class="btn btn-primary buttons" value="Просмотреть успеваемость выбранного"
                       onclick="progressStudents()">
                <input type="submit" class="btn btn-primary buttons" value="Модифицировать выбранного"
                       onclick="modifyStudents()">
                <input type="submit" class="btn btn-primary buttons" value="Удалить выбранных студентов"
