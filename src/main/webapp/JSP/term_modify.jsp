...
<div class="container modify">
    <p class="modify">Выберите дисциплины, которые нужно убрать из семестра и нажмите "Применить".</p>

    <form action="/term_modify" method="post">
        <div class="row tabmodify">
            <div class="col-sm-6">

                <input type="hidden" class="form-control"
                       value="${termFirst.id}" name="id" >
                <input type="text" class="form-control" placeholder="Длительность в неделях"
                       value="${termFirst.duration}" name="duration" required>
