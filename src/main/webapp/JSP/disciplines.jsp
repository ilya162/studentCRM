    ...
    <div class="row">
        ...
        <div class="col-sm-7 disptbut">
            <div class="d-grid gap-4 col-6 mx-auto">
                ...
                <input type="submit" class="btn btn-primary buttons" value="Удалить дисциплину" onclick="deleteDiscipline()" >
            </div>
        </div>
    </div>
</div>
<form id = "modifyDisciplineForm" action="/discipline_modify" method="get">
    <input type="hidden" id="modifyDisciplineHidden" name="modifyDisciplineHidden">
</form>
<form id = "deleteDisciplineForm" action="/deleteDiscipline" method="post">
